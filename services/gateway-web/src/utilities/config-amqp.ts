...
export async function connectRabbitMQ() {
  ...
  const { GATEWAY_WEB_RABBIT_USER, GATEWAY_WEB_RABBIT_PASSWORD } = process.env;
  fullConnString = [fullConnString[0], "://", GATEWAY_WEB_RABBIT_USER!, ":", GATEWAY_WEB_RABBIT_PASSWORD!, '@', fullConnString[1]];
